...
const testimonials = [
  {
    ...
    company: "Century 21",
    content: "İlanX ile portföylerime eklediğim arsa ilanlarının görüntülenmesi ilan sitelerinde 4 kat arttı. İlk hafta 2 arsayı hemen sattık!",
    rating: 5,
  },
  {
    name: "Zeynep Kaya",
    ...
    company: "Kaya Emlak",
    content: "Artık serbest tasarımcılara para ödemeyi tamamen bıraktık. Ekibimiz sadece 2 dakikada dikkat çeken neon videolar hazırlıyor.",
    rating: 5,
  },
  {
    name: "Mehmet Demir",
    ...
    content: "Alıcılar arsanın sınırlarını net olarak gördükleri için gereksiz aramalar azaldı. Sadece ciddi alıcılar arıyor, zamanım bana kaldı.",
    rating: 5,
  },
]
