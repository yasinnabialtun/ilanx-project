...
import { Download, ArrowRight, Loader2, Play, VideoIcon, PenTool, Sparkles } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-neutral-950 flex flex-col">
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto p-4 sm:p-6 lg:p-8 pt-8">
        ...
        {/* Header */}
        <div className="mb-12">
          <h1 className="text-3xl sm:text-4xl font-bold text-white mb-2">İlanX Stüdyo Paneli 👋</h1>
          <p className="text-white/60">Tüm araçlar ücretsiz — kayıt olmadan, limitsiz kullanın.</p>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            {!loadingVideos && videos.length === 0 && (
              <div className="col-span-full aspect-[9/16] max-w-sm mx-auto border-2 border-dashed border-white/10 rounded-2xl flex flex-col items-center justify-center p-6 text-center bg-white/[0.02]">
                ...
                <p className="text-sm text-white/50">Henüz hiç video oluşturulmadı. Hemen stüdyoya gidin ve ilk videonuzu oluşturun.</p>
